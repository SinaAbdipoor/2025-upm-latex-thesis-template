...
There may be a preamble at the beginning of a chapter. The purpose may be to introduce the themes of the main headings. This is how to cite a paper \parencite{abdipoor2023meta}. And this is how to use acronyms, \ac{upm}.
...
\caption{Number of visitors according to participation in different activities}\label{tab:visitor-count}
\begin{tabular}{|l|c|c|}
    \hline
...
\begin{table}[h]
%\centering
\caption{Number of visitors according to participation in different activities}\label{tab:visitor-count-2}
\begin{tabular}{lcc}
    \hline
    \textbf{Activity} & \textbf{\makecell{No. of participants\\(N=96)}} & \textbf{NA} \\
    \hline
...
\begin{figure}[h]
    ...
    \caption{The Corporate Governance Framework in Malaysia—The Onion Model}\label{fig:onion}
\end{figure}